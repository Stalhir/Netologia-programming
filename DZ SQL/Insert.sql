...
insert into performer(name) values('MyАндрей');
...
insert into track(duration, id_album, name) values('00:05:23', 3,'Сигареты');
insert into track(duration, id_album, name) values('00:07:30', 2,'Група крови');
insert into track(duration, id_album, name) values('00:02:12', 3,'Пиво');
insert into track(duration, id_album, name) values('00:03:59', 1,'Час');
insert into track(duration, id_album, name) values('00:05:35', 1,'Дом');
insert into track(duration, id_album, name) values('00:04:12', 3,'Улица');
